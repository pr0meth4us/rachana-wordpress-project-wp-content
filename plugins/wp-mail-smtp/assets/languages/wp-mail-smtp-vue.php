...
$generated_i18n_strings = array(
	...
	// Reference: src/modules/settings/api/index.jsx:265
	...
	// Reference: src/modules/settings/api/index.jsx:84
	...
	// Reference: src/modules/setup-wizard/api/index.jsx:16
	__( 'It looks like we can\'t perform the mailer configuration check.', 'wp-mail-smtp' ),

	// Reference: src/modules/setup-wizard/api/index.jsx:37
	__( 'It looks like we can\'t send the feedback.', 'wp-mail-smtp' ),

	// Reference: src/modules/plugins/api/index.jsx:69
	// Reference: src/modules/settings/api/index.jsx:267
	// Reference: src/modules/setup-wizard/api/index.jsx:39
	/* Translators: Error status and error text. */
	__( '%1$s, %2$s', 'wp-mail-smtp' ),

	// Reference: src/modules/settings/api/index.jsx:271
	// Reference: src/modules/setup-wizard/api/index.jsx:43
	__( 'You appear to be offline.', 'wp-mail-smtp' ),

	// Reference: src/modules/settings/api/index.jsx:113
	__( 'It looks like we can\'t save the settings.', 'wp-mail-smtp' ),

	// Reference: src/modules/settings/api/index.jsx:119
	__( 'Network error encountered. Settings not saved.', 'wp-mail-smtp' ),

	// Reference: src/modules/settings/api/index.jsx:139
	__( 'It looks like we can\'t import the plugin settings.', 'wp-mail-smtp' ),

	// Reference: src/modules/settings/api/index.jsx:145
	__( 'Network error encountered. SMTP plugin import failed!', 'wp-mail-smtp' ),

	// Reference: src/modules/settings/api/index.jsx:172
	__( 'It looks like we can\'t load authentication details.', 'wp-mail-smtp' ),

	// Reference: src/modules/settings/api/index.jsx:235
	__( 'It looks like we can\'t remove OAuth connection.', 'wp-mail-smtp' ),

	// Reference: src/modules/settings/api/index.jsx:21
	__( 'It looks like we can\'t load the settings.', 'wp-mail-smtp' ),

	// Reference: src/modules/settings/api/index.jsx:51
	__( 'It looks like we can\'t retrieve Amazon SES Identities.', 'wp-mail-smtp' ),

	// Reference: src/modules/settings/api/index.jsx:57
	__( 'Can\'t retrieve Amazon SES Identities.', 'wp-mail-smtp' ),

	// Reference: src/modules/settings/api/index.jsx:90
	__( 'Can\'t register the Amazon SES Identity', 'wp-mail-smtp' ),

	// Reference: src/modules/plugins/api/index.jsx:25
	__( 'It looks like the plugin installation failed!', 'wp-mail-smtp' ),

	// Reference: src/modules/plugins/api/index.jsx:35
	__( 'It looks like we can\'t install the plugin.', 'wp-mail-smtp' ),

	// Reference: src/modules/plugins/api/index.jsx:41
	__( 'You appear to be offline. Plugin not installed.', 'wp-mail-smtp' ),

	// Reference: src/modules/plugins/api/index.jsx:58
	__( 'Can\'t fetch plugins information.', 'wp-mail-smtp' ),

	// Reference: src/modules/plugins/api/index.jsx:67
	__( 'It looks like we can\'t fetch plugins information.', 'wp-mail-smtp' ),

	// Reference: src/modules/plugins/api/index.jsx:73
