...
registerBlockType( 'egov-block-2/slide-list', {
		...
		return (
			<Fragment>
				<InspectorControls>
					...
					>
						<SelectControl
							label={ __( 'Display Style', 'egov' ) }
							value={ style }
							options={ [
								{
									label: __( 'Style 1', 'egov' ),
									value: 1
								},
								{
									label: __( 'Style 2', 'egov' ),
									value: 2
								}
							] }
						...
						<NumberControl
							...
							value={ slide_to_show }
							onChange={ ( value ) => setAttributes( { slide_to_show: value } ) }
							isShiftStepEnabled={ true }
							shiftStep={ 5 }
							min={ 1 }
						/>
